...
# Внимание !
Данная инструкция скорее всего не применима к русифицированным прошивкам, в которых есть голосовые ассистенты (ЕвропаКар, GMC), и установка данного приложения может привести к непредвиденным проблемам. Создатель ассистента не несет ответственности за установку поверх сторонних решений.
